...
public interface ProductDao extends JpaRepository<Product,Integer>{
	...
	Product getByProductName(String productName);/*getBy a göre bir where koyuyor
...
//select *(p.productId, p.productName, c.) from category c inner join product p on c.categoryId = p.categoryId
}
